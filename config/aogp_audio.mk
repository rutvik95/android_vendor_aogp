...
ALARM_PATH := vendor/aogp/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/aogp/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/aogp/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/aogp/prebuilt/common/media/audio/ui
